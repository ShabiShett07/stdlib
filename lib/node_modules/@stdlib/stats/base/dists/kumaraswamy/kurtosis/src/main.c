...
*
* @example
* double v = stdlib_base_dists_kumaraswamy_kurtosis( 4.0, 12.0 );
* // returns ~2.704
*
* @example
* double v = stdlib_base_dists_kumaraswamy_kurtosis( 12.0, 2.0 );
* // returns ~4.817
*
* @example
* double v = stdlib_base_dists_kumaraswamy_kurtosis( 1.0, -0.1 );
* // returns NaN
*
* @example
* double v = stdlib_base_dists_kumaraswamy_kurtosis( -0.1, 1.0 );
* // returns NaN
*
* @example
* double v = stdlib_base_dists_kumaraswamy_kurtosis( 2.0, NaN );
* // returns NaN
*
* @example
* double v = stdlib_base_dists_kumaraswamy_kurtosis( NaN, 2.0 );
* // returns NaN
*/
