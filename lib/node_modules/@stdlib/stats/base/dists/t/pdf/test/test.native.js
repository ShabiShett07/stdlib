...
tape( 'the function evaluates the pdf for `x` given a large range of `v` and `x`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function evaluates the pdf for `x` given a large range of `v` and small range of `x`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function evaluates the pdf for `x` given a small range of `v` and large range of `x`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function evaluates the pdf for `x` given a small range of `v` and `x`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
